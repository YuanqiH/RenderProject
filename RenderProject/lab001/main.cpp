...
int main()
{
	...
	/*
	// model for previous labs (bump-map)
	// Load bump map model 
	...
	*/
	...
	MyTexture orangeText[2];// load two texture manually, 0 for diffuse texture, 1 for normal map. (loader is too bad)
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		/*
		// rendering of previous labs. (reflection and refraction)
